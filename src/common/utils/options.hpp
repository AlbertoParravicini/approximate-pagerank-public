...
#define DEFAULT_MTX_FILE "../../data/graphs/mtx/scf_2019_10_02_13_26_56.mtx"
//#define DEFAULT_MTX_FILE "../../data/graphs/mtx/graph_small_c16.mtx"
...
struct Options {
    ...
    index_type personalization_vertex = (index_type) rand();
    ...
    Options(int argc, char *argv[]) {
    	...
    	// p: personalization vertex in personalized pagerank, default random
        int opt;
        static struct option long_options[] = {{"debug", no_argument, 0, 'd'},
											   ...
											   {"personalization_vertex", required_argument, 0, 'p'},
                                               {0, 0, 0, 0}};
        // getopt_long stores the option index here;
        int option_index = 0;

        while ((opt = getopt_long(argc, argv, "dg:m:e:sca:t:ux:o:p:", long_options, &option_index)) != EOF) {
            switch (opt) {
                case 'd':
                    debug = true;
                    break;
                ...
                case 'o':
                    ...
                    break;
                case 'p':
                	personalization_vertex = atoi(optarg);
                default:
                    break;
            }
        }
